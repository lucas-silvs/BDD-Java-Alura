...
public class LeilaoSteps {
    ...
    public void preenche_o_formulario_com_dados_validos() {
        this.leiloesPage = this.novoLeilaoPage.preencheForm("PC Novo","1500","01/11/2021");
    }
    ...
    public void o_novo_leilao_aparece_na_tabela() {
        Assert.assertTrue(this.leiloesPage.existeLeilao("PC Novo","1500","01/11/2021","fulano"));
